...
Future<html.DirectoryEntry> getLocalDataDir(String name) {
  print("### getLocalDataDir  A");
  return getLocalDataRoot().then((html.DirectoryEntry root) {
    return html.window.resolveLocalFileSystemUrl(root.toUrl()).then((html.Entry e){
      print("##TEST OK##");
      print("##TEST OK# ${e} ${e.fullPath} ${e.toUrl()}");
      return (e as html.DirectoryEntry).createDirectory(name, exclusive: false);
    });
/*
    print("### getLocalDataDir  B ${root} ${root.toUrl()}");
    Future<html.Entry> r = root.createDirectory(name, exclusive: false);
    print("### getLocalDataDir  C ${root}");
    return r;
     */
  });
}
